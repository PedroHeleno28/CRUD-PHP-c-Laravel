            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="{{ route('carros.index') }}" class="nav-link">Home</a></li>                  
                  <li><a href="{{ route('carros') }}" class="nav-link">Carros</a></li>                                    
                  <li><a href="{{ route('login') }}" class="nav-link">Login</a></li>  
                  <li>
                    <form method="POST" action="{{ route('logout') }}" class="d-inline">
                      @csrf
                      <button type="submit" class="nav-link text-white" style="background: none; border: none; padding: 8px 15px; font-family: inherit; font-size: inherit;">Sair</button>
                    </form>
                  </li>
                </ul>
              </nav>
