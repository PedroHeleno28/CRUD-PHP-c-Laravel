    ...
    <aside class="left-sidebar">
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="{{ route('carros.inicio') }}" class="text-nowrap logo-img">
            <img src="https://i.ibb.co/kV6MR301/Heleno-Automotivo-azul-branco.png" alt="loh" 
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('carros.inicio') }}" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="{{ route('marcas') }}" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="{{ route('modelos') }}" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="{{ route('cores') }}" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-shopping-cart"></i>
                  </span>
                  <span class="hide-menu">Cores</span>
                </div>                
              </a>
            </li>
            <!--
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <a href="{{ route('password.confirm') }}" class="d-flex align-items-center gap-2 dropdown-item">
                      <i class="ti ti-mail fs-6"></i>
                      <p class="mb-0 fs-3">Alterar senha</p>
                    </a>                    
